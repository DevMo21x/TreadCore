...
INSERT INTO `__new_workouts`("workout_id", "user_id", "start_time", "end_time", "total_distance_km", "avg_speed_kmh", "total_calories", "total_elevation_gain") SELECT "workout_id", "user_id", "start_time", "end_time", "total_distance_km", "avg_speed_kmh", "total_calories", "total_elevation_gain" FROM `workouts`;--> statement-breakpoint
